...
Welcome to the **Elo Organico** development environment. This project is a specialized management platform for organic product sharing cycles, built as a high-performance, strictly-typed monorepo.
...
3.  **Run Development Environment:**
    ...
    ```bash
    pnpm dev:docs           # Start documentation (Docusaurus)
    pnpm instance:dev:web   # Start community shop/admin only
    pnpm instance:dev:api   # Start community API only
    pnpm portal:dev:web     # Start official portal only
    pnpm portal:dev:api     # Start portal API only
    ```
