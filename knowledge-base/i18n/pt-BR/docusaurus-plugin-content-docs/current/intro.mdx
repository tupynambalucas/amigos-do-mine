...
Certifique-se de ter o **Node.js 22+** e o **PNPM 10+** instalados.
...
3.  **Executar Ambiente de Desenvolvimento:**
    ...
    ```bash
    pnpm dev:docs           # Iniciar documentação (Docusaurus)
    pnpm instance:dev:web   # Iniciar apenas loja/admin da comunidade
    pnpm instance:dev:api   # Iniciar apenas API da comunidade
    pnpm portal:dev:web     # Iniciar apenas portal oficial
    pnpm portal:dev:api     # Iniciar apenas API do portal
    ```
