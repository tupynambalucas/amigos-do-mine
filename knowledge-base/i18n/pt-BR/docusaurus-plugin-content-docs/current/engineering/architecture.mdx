...
| :--------------------- | :------------------- | :------------ | :------------------------------------------------------------- |
| portal/apps/web        | @elo-portal/web      | **Singleton** | Portal oficial global, landing page e hub de entrada do SaaS. |
...
- **Implantação (Deployment)**:
  - **Portal**: Existe apenas **uma** instância global da plataforma. Ela serve como a face do projeto e a porta de entrada para todo o ecossistema.
